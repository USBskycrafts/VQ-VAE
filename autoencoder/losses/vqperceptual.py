...
from autoencoder.losses.lpips import OneChannelLPIPS as LPIPS
from autoencoder.discriminator.model import NLayerDiscriminator, weights_init
...
class VQLPIPSWithDiscriminator(nn.Module):
    ...
    def calculate_adaptive_weight(self, nll_loss, g_loss, last_layer=None):
        if last_layer is not None:
            ...
            raise RuntimeError(
                "last_layer is None, cannot calculate adaptive weight.")
    ...
    def forward(self, codebook_loss, inputs, reconstructions, optimizer_idx,
        ...
        rec_loss = torch.abs(inputs.contiguous() -
                             reconstructions.contiguous()) * self.pixel_weight
